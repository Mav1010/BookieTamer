...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #import teams
        with open('C:\\Users\\Mac\\PycharmProjects\\BookieTamer\\full_data.csv', 'r') as f:
            ...
            for row in reader:
                ...
                if not all_games.filter(game_id=game_id).exists():
                    ...
                    try:
                        new_match = Match(game_id=game_id, division=division, date=date, home_team=home_team, away_team=away_team, ft_home_goals=ft_home_goals, ft_away_goals=ft_away_goals, ft_result=ft_result,
